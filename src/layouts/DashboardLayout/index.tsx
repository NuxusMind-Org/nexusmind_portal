      ...
      <div>
        ...
        <div className="p-6 border-b border-[#202235] space-y-1">
          <div className="flex items-center gap-2.5">
            <div className="bg-violet-600/20 text-violet-400 p-1.5 rounded-lg border border-violet-500/30">
            ...
            <span className="text-xl font-bold text-white tracking-wide">NexusMind</span>
          </div>
          <p className="text-[10px] font-semibold text-slate-500 tracking-widest uppercase pl-9">Enterprise AI</p>
        </div>
