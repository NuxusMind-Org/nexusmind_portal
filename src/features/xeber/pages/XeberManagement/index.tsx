          ...
          <div className="w-full max-w-5xl bg-[#141521] border border-[#2e3146] rounded-2xl p-6 sm:p-8 shadow-2xl space-y-6 animate-scale-up max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-[#2e3146] pb-4">
              <h3 className="text-xl font-bold text-white flex items-center gap-2.5">
                ...
                <span>{editingItem ? 'Edit News Item (PUT)' : 'Create News Item (POST)'}</span>
              </h3>
              <button
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-200">Featured Quote</label>
                  <input
                    type="text"
                    value={quote}
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-200">Quote Author</label>
                  <input
                    type="text"
                    value={quoteAuthor}
              ...
              <div className="space-y-4 pt-4 border-t border-[#2e3146]">
                  ...
                  {previewKeywords.length > 0 && (
                    <div className="flex flex-wrap gap-2 pt-1.5">
                      {previewKeywords.map((kw, i) => (
                        <span
                          key={i}
                          className="px-2.5 py-1 rounded-lg bg-violet-500/10 border border-violet-500/20 text-violet-300 text-xs font-mono flex items-center gap-1.5"
                        >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-[#1b1c2b] border border-[#2e3146] rounded-xl text-sm text-emerald-400 font-mono placeholder-slate-600 focus:outline-none focus:border-violet-500 leading-relaxed transition-colors"
                  />
                  {jsonError && (
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-[#2e3146]">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="px-7 py-3 rounded-xl bg-violet-600 hover:bg-violet-500 text-white text-sm font-bold transition-all flex items-center gap-2.5 cursor-pointer shadow-[0_4px_16px_rgba(124,58,237,0.3)]"
                >
